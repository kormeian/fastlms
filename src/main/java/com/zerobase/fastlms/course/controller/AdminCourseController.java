...
public class AdminCourseController extends BaseController {
    ...
    private String[] getNewSaveFile(String baseLocalPath, String baseUrlPath,
        ...
        String[] dirs = {
                ...
                String.format("%s/%d/%02d/", baseLocalPath, now.getYear(),
                        now.getMonthValue()),
    ...
    public String addSubmit(Model model, HttpServletRequest request
        ...
        if (file != null) {
            ...
            String baseLocalPath = "/Users/kyutaepark/Documents/sources" +
                    "/zerobase/fastlms/files";
            String baseUrlPath = "/files";

            String[] arrFilename = getNewSaveFile(baseLocalPath, baseUrlPath,
                    originalFilename);
